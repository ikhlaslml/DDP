...
<!DOCTYPE html>
<html lang="id" x-data="{ selected: 1 }" xmlns="http://www.w3.org/1999/xhtml">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <title>Data Desa Presisi Cerita Kami</title>
  <!-- Bootstrap CSS -->
  
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">

<!-- Bootstrap JS (jQuery not needed for Bootstrap 5) -->
...
<script>
  ...
  fetch("team.html").then(res => res.text()).then(data => {
    document.getElementById("team-placeholder").innerHTML = data;
  });

</script>
<!-- Bootstrap JS (agar collapse/accordion berfungsi) -->
